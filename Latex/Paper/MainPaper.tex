...
The bipolar stepper motor used, requires a pulse trough each of the four connections in a fixed pattern in order to rotate it forward or backward.
...
% The weight of the robot influences the drag / rolling resistance.
