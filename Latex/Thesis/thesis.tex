...
\newcommand{\reportAbstract}{
	...
	This results in a new phenomenon to be taken into consideration: frequent power interrupts due to the the intermittent availablility of energy.
	Intermittentcy is currently not taken into account in the development process of a robot, and its effect on control techniques and locomotion is, therefore, unexplored.
