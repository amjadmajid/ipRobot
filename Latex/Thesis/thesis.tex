...
\newcommand{\reportAbstract}{
	...
	New advancements in batteries are not expected to happen anytime soon as history shows that new battery technologies are often overhyped.
	...
	The performance of the transiently-powered robot is evaluated and shows minimal increased deviation from its path when compared to its battery powered equal, given a experimentially determined minimum interrupt period of 0.3\,s.
}
