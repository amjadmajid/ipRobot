...
\newcommand{\reportAbstract}{
	...
	Therfore, this thesis proposes to replace the battery with an energy harvester and temporarily store harvested energy in a supercapacitor.
	This results in a new phenomenon to be taken into considerationi in designing a robot: frequent power failures due to the the intermittent availablility of energy.
	...
	The transiently-powered robot shows minimal increased deviation from its instructed path when compared to its battery powered equivalent, given an experimentially determined minimum interrupt period of 0.3\,s.
