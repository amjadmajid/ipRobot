...
\newcommand{\reportAbstract}{
	...
	This thesis proposes to replace the battery with an energy harvester and temporarily store harvested energy in a supercapacitor, which creates a new phenomenon to be taken into consideration; the intermittent source of energy results in frequent power interrupts.
	...
	Energy is harvested from light using a lighting setup containing four halogen lamps making the robot is able to move with a 16\% power duty cycle.
