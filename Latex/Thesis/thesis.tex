...
\newcommand{\reportAbstract}{
	...
	Using local feedback the robot is able to make controlled movements, while peristent state variables enable the robot to save the movement progress across power cycles.
	The performance of the transiently-powered robot is evaluated and shows no sigificant differences in movement accuracy when compared to its battery powered equal, given an minimum interrupt period of 0.3\,s.
}
