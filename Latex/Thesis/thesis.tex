...
\newcommand{\reportAbstract}{
	...
	The transiently-powered robot shows minimal increased deviation from its instructed path when compared to its battery powered equivalent, given an experimentially determined minimum on time of 0.3\,s.
