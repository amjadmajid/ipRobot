...
\section{Model Transiently-powered Actuation}
\label{sec:model_transient}
...
The energy stored in the supercapacitor should provide at least an operation time of 1 second, allowing the robot to make small controlled movements.
...
One of the requirements for the robot was that it should have accurate locomotion and basic odometry.
