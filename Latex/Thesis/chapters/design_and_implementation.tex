...
This timer is able to directly-control the four IO-ports, eliminating the overhead of a ISR.
The control loop updates the compare registers for each of the ports.
