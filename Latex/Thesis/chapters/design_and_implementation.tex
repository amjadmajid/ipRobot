...
Using a interrupt has the benefit of a constant sample time, which simplifies the PID loop because the integration and differentiation time are also constant and known in advance.
