			...
			\label{tab:comparison_robot_platforms}
	 		\begin{tabular}{|l l l l l l|} 
				\hline 
	 			...
	 			(N/A) & 1 cm/s                                                 &        &       &            &       \\
	 			Roverables \cite{dementyev_uist_2016} & wheel, & 4.0 cm & 36 g\textsuperscript{3} & 100 mAh, 45 m & inductive \\
	 			(\euro34) & ??                                     &        &    &               &           \\                          
	 			Zooids \cite{legoc_uist_2016}& wheel, & 2.6 cm & 12 g & 100 mAh 1 h & manual \\
	 			(\euro43)                    & 50 cm/s &       &      &             &        \\                  
	 			mROBerTO \cite{kim_iros_2016} & motor shaft, & 1.5 cm & 10 g\textsuperscript{3} & 120 mAh, 1.5 h & manual \\
	 			(\euro52 \textsuperscript{2}) & 15 cm/s      &        &    &               &         \\
	 			GRITSBot \cite{pickem_icra_2015} & wheel, & 3 cm & 60 g\textsuperscript{3} & 150 mAh, 1 h & contact \\
	 			(\euro43\textsuperscript{2}) & 25 cm/s    &      &    &                &         \\
	 			Kilobot \cite{rubenstein_icra_2012} & vibration, & 3.3 cm & 17.6 g\textsuperscript{3} & 160 mAh, 3 h & manual \\
	 			(\euro43\textsuperscript{2}) & 1 cm/s            &        &    &              & bulk \\
	 			TinyTerp \cite{sabelhaus_icra_2013} & wheel, & 1.8 cm & N\textbackslash A & 50 mAh, 1 h & manual \\
	 			(\euro43)                           &50 cm/s &        &    &             &        \\
				\hline
			\end{tabular}
			\begin{tablenotes}
