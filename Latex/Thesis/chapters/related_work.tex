	 		...
	 		\begin{tabular}{|l l l l l l l l l|} 
				\hline 
	 			Robot  & Cost & Locomotion & Speed & Size & Weight & Energy  & Operation & Recharge\\ 
	 			       & (\euro)&          & (cm/s)&      &        & Capacity (mAh)& Time      & Method \\ 
	 			\hline\hline
	 			IPR & 59 & wheel & 25 & 4.0 cm & 21 g & 0.006 & 1 s & solar \\
	 			Roverables \cite{dementyev_uist_2016} & 34\textsuperscript{3} & wheel & N/A & 4.0 cm & 36 g\textsuperscript{3} & 100 & 45 min & inductive \\                    
	 			Zooids \cite{legoc_uist_2016}& 43 & wheel & 50 & 2.6 cm & 12 g & 100 & 1 h & manual \\      
	 			mROBerTO \cite{kim_iros_2016} & 52\textsuperscript{2} &motor shaft & 15 & 1.5 cm & 10 g\textsuperscript{3} & 120 & 1.5 h & manual \\
	 			GRITSBot \cite{pickem_icra_2015} & 43\textsuperscript{2} & wheel & 25 & 3 cm & 60 g\textsuperscript{3} & 150 & 1 h & contact \\
	 			TinyTerp \cite{sabelhaus_icra_2013} & 43 & wheel & 50 & 1.8 cm & N\textbackslash A & 50 & 1 h & manual \\
	 			Kilobot \cite{rubenstein_icra_2012} & 43\textsuperscript{2} & vibration & 1 & 3.3 cm & 17.6 g\textsuperscript{3} & 160 & 3 h & manual (bulk) \\
				HAMR-VP\textsuperscript{1} \cite{bruhwiler_iros_2015}& N/A & legged & 44 & 4.4 cm & 2.3 g & 8 & 3 min & manual \\
				\hline
			\end{tabular}
			\begin{tablenotes}
				\small
