...
% Specifiy exactly which variables are persistent and which are not!
% All the control loop variables are reset when exiting the loop!

% Store both lspeed and rspeed while not a straight or curved movement is not yet finished
