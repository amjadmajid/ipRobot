...
A complete overview of the robot can be found in Figure \ref{fig:robot_overview} and a more detailed schematic of the PCB can be found in Appendix \ref{app:schematic_robot}.
