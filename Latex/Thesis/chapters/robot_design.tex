...
Based on this, there was searched for commercially available components with the lowest minimal supply voltage.
...
In addition the robot has a Bosch Sensortec BMG250 low power triaxial gyroscope to measure yaw-rate, used to correct it's heading when necessary.

\subsection{Locomotion}

% Motors indude a gearbox 25:1
