...
\begin{table}[t]
	...
	\begin{threeparttable}
		...
		\begin{tabularx}{0.7\textwidth}{l@{\hskip 0.6in}l} 
			...
			Two DC motors\textsuperscript{1} & 27-50mA  \\
			\hline
			\\[-1em]
			Total & 29-52mA \\
			\hline
...
When the set point is just to high a kind of clicking noise can be heard, indicating that the start current peak of motor is to high and the buck converter is not able to supply the current.
