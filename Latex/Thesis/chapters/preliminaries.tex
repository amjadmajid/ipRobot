...
The design considerations for the robot is explained based on minimal required capabilities in Section \ref{sec:pre_design_requirements}.
...
However, the PWM duty cycle is limited to a maximum of $100/(2*140/110) \approx 39\%$, and is further reduced by the load applied to the motors as a result of the robots own weight.
