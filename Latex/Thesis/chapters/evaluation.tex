...
Each movement is executed at three different PWM target settings: 40\%, 65\% and 90\% of the maximum target setting.
...
The camera is used to record the movement which is analyzed using Python and OpenCV 3.2, a example of a tracked movement can be seen from Figure \ref{fig:movement_example}.
...
\begin{figure}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		...
		\caption{Recorded movement is tracked with OpenCV}
