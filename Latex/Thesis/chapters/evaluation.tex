...
To determine the accuracy of the circular movement a circle, with varying radius due to the differences in the calibrated speed, will be visually fitted to the circular data of each movement.
...
The straight line movements show more horizontal deviation by decreasing the interrupt period towards the lower threshold.
For the circular movements the average deviation from the reference circle is reduced by increasing the target duty cycle.
The solar powered robot outperforms the battery powered robot, as the additional weight and weight distribution of the solar panel has a positive effect on the accuracy of movement of the robot.
