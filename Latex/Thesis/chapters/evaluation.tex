...
The results show that a interrupt period of 0.2\,s results in uncontrolled behavior, while the robot drifts to the side of the weakest motor, as shown in Figure \ref{fig:decreasing_power_period}.
...
Another thing that can be observed from the results in \ref{fig:decreasing_power_period}, is that the distance covered by the robot deceases by deceasing the target and/or power interrupt period.
