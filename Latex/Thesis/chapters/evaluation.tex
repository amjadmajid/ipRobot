...
Each movement is then executed at three different PWM target settings: 30, 50 and 70.
...
%Each movement is preformed for the three velocities as mentioned in the previous section.
...
\begin{table}
	...
	\resizebox{\columnwidth}{!}{%
		\begin{tabular}{|l|l|l|l|l|}
			\hline
			\textbf{Movement} &  Straight 75 cm & Square 50x50 cm & Circle R30 cm  & \\
			\hline
			\textbf{PWM} & 30 & 50 & 70 &  \\
			\hline
			\textbf{Interrupt period} & 1.25 s & 1.0 s & 0.75 s  & 0.5 s \\
			\hline
		\end{tabular}
	}
\end{table}
